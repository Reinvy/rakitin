...
describe('FileValidator vs real disk artifacts', () => {
  test('accepts a well-formed modular router', () => {
    ...
    const result = FileValidator.validateModularRouterFile('catalog', getPaths().basePath);
  ...
  test('PathResolver emits import paths consistent with actual files', () => {
    ...
    const expectedPath = PathResolver.getModularRouterPath('billing', getPaths().basePath);
