...
describe("Router Generator", () => {
  ...
  describe("integrateRouter", () => {
    ...
    test("should accept required parameters", () => {
      ...
      PathResolver.getModularRouterPath.mockReturnValue(
        "/test/path/modules/user-module/routes/user-module.router.js"
      );
      PathResolver.getSimpleControllerPath.mockReturnValue(
        "/test/path/modules/user-module/user-module.controller.js"
      );
    ...
    test("should handle validation errors", () => {
      ...
      ErrorHandler.handleRouterIntegrationErrors.mockReturnValue({
        ...
        details: {
          errors: ["Directory not found"],
          failedModules: ["userModule", "productModule"],
        },
      });
