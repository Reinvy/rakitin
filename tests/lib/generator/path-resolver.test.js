...
describe('PathResolver', () => {
  ...
  describe('normalizeModuleName', () => {
    test('should convert camelCase to kebab-case', () => {
      ...
      expect(PathResolver.normalizeModuleName('myComplexModule')).toBe('my-complex-module');
    });
    ...
    test('should convert spaces to hyphens', () => {
      ...
      expect(PathResolver.normalizeModuleName('my complex module')).toBe('my-complex-module');
    });

    test('should handle mixed cases', () => {
      expect(PathResolver.normalizeModuleName('User Module')).toBe('user-module');
      expect(PathResolver.normalizeModuleName('myComplex Module')).toBe('my-complex-module');
    });
    ...
    test('should throw error for empty string', () => {
      expect(() => PathResolver.normalizeModuleName('')).toThrow('Nama modul harus berupa string yang tidak kosong');
    });

    test('should throw error for non-string input', () => {
      expect(() => PathResolver.normalizeModuleName(null)).toThrow('Nama modul harus berupa string yang tidak kosong');
      expect(() => PathResolver.normalizeModuleName(undefined)).toThrow('Nama modul harus berupa string yang tidak kosong');
      expect(() => PathResolver.normalizeModuleName(123)).toThrow('Nama modul harus berupa string yang tidak kosong');
      expect(() => PathResolver.normalizeModuleName({})).toThrow('Nama modul harus berupa string yang tidak kosong');
    });
  });
  ...
  describe('getModularRouterPath', () => {
    test('should return correct path for modular router', () => {
      ...
      expect(result).toBe(path.join(basePath, 'modules', 'user-module', 'routes', 'user-module.router.js'));
    });
  ...
  describe('getSimpleControllerPath', () => {
    test('should return correct path for simple controller', () => {
      ...
      expect(result).toBe(path.join(basePath, 'modules', 'user-module', 'user-module.controller.js'));
    });
  ...
  describe('ensureDirectoryExists', () => {
    test('should create directory if it does not exist', () => {
      const filePath = path.join(global.tempDir, 'modules', 'user-module', 'routes', 'user-module.router.js');
