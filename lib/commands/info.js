...
const CATALOG = [
  ...
  { command: "recipe auth", tiers: ["advanced"], desc: "JWT auth recipe lengkap (middleware+user module+joi)" },
  { command: "recipe test", tiers: ["advanced"], desc: "Scaffold jest + supertest per modul" },
  { command: "recipe docker", tiers: ["advanced"], desc: "Dockerfile + compose + .dockerignore" },
