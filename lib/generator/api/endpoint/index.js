...
async function generateEndpoint(targetModuleArg, resourceNameArg, fieldsInputArg, includePaginationArg, includeFilteringArg) {
  let options = {};
  if (typeof targetModuleArg === "object" && targetModuleArg !== null) {
    options = targetModuleArg;
  } else {
    options = {
